...
void TestEncodeTeros21(void) {
  ...
  buffer_len = EncodeTeros21Measurement(1737671549, 51, 12, 134.5, 22.4, buffer);

  uint8_t data[] = {0xa, 0xa, 0x8, 0xc, 0x10, 0x33, 0x18, 0xfd, 0x86, 0xcb,
    0xbc, 0x6, 0x32, 0x12, 0x9, 0x0, 0x0, 0x0, 0x0, 0x0, 0xd0, 0x60, 0x40,
    0x11, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x36, 0x40};
  size_t data_len = 32;
