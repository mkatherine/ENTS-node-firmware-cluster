...
#ifndef __SDI12_V1_H__
#define __SDI12_V1_H__
...
#define SCALE_TMP_TO_INT 10
  ...
  ******************************************************************************
  */
  void SDI12_WakeSensors_V1(void);
  ...
  ******************************************************************************
  */
  void SDI12_SendCommand_V1(const char *command, uint8_t size);
  ...
  ******************************************************************************
  */
  HAL_StatusTypeDef SDI12_ReadData_V1(char *buffer, uint16_t bufferSize, uint16_t timeoutMillis);
