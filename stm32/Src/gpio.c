...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SDI12_GPIO_Port, SDI12_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_0
                          |GPIO_PIN_9|GPIO_PIN_6|GPIO_PIN_1|GPIO_PIN_7
  ...
  /*Configure GPIO pins : PC2 PC1 PC0 PC6 */
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = SDI12_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SDI12_GPIO_Port, &GPIO_InitStruct);
